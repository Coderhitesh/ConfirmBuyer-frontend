...
const BuyersPage = () => {
    ...
    const handleCallBack = async (e) => {
        ...
        try {
            const response = await axios.post(
                "https://confirmbuyers.onrender.com/api/Buyer-callback",
                formdata
            );
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className=" text-xl sm:text-5xl md:text-8xl text-center font-semibold mb-8">Get the Best <span className="text-violet-700">Buyers</span> Services</h1>
            <p className="text-lg font-bold text-center mb-8">Find the best Buyers <span className="text-violet-700">services you need</span> to help you successfully meet your product planning goals and deadlines.</p>
